...
Route::post('/todo-item/pendent/{id}', [TodoItemController::class, 'markAsPendent'])->name('app.todo.item.mark-pendent');
Route::get('/todo-item/history/{id}', [TodoItemController::class, 'getHistory'])->name('app.todo.item.history');
